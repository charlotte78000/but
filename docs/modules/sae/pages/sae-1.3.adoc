...
:mywidth: 32
image:sae-1.3/descriptif.png["descriptif",width={mywidth}%,pdfwidth={mywidth}%]
image:sae-1.3/cursus.png["cursus",width={mywidth}%,pdfwidth={mywidth}%]
image:sae-1.3/competences.png["competences",width={mywidth}%,pdfwidth={mywidth}%]
