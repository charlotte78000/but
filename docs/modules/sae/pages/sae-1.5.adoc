...
:mywidth: 32
image:sae-1.5/descriptif.png["descriptif",width={mywidth}%,pdfwidth={mywidth}%]
image:sae-1.5/cursus.png["cursus",width={mywidth}%,pdfwidth={mywidth}%]
image:sae-1.5/competences.png["competences",width={mywidth}%,pdfwidth={mywidth}%]
...
====
- {ep} (p)
- {jmb} (p) image:sae-1.5/jmb.jpg[width=10%, pdfwidth=10%] 
- {lc}  (v)
+
