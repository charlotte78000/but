...
:mywidth: 32
image:sae-2.1/descriptif.png["descriptif",width={mywidth}%,pdfwidth={mywidth}%]
image:sae-2.1/cursus.png["cursus",width={mywidth}%,pdfwidth={mywidth}%]
image:sae-2.1/competences.png["competences",width={mywidth}%,pdfwidth={mywidth}%]
