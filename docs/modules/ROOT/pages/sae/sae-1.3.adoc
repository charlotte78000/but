...
:mywidth: 32
image:sae/sae-1.3/descriptif.png["descriptif",width={mywidth}%,pdfwidth={mywidth}%]
image:sae/sae-1.3/cursus.png["cursus",width={mywidth}%,pdfwidth={mywidth}%]
image:sae/sae-1.3/competences.png["competences",width={mywidth}%,pdfwidth={mywidth}%]
...
En S2, la SAÉ relative aux compétences xref:competences/c1.adoc[Compétence 1 ({c1-title})], xref:competences/c4.adoc[Compétence 4 ({c4-title})], xref:competences/c5.adoc[Compétence 5 ({c5-title})] et xref:competences/c1.adoc[Compétence 6 ({c6-title})] vous amènera à travailler en groupe pour développer une application. 
