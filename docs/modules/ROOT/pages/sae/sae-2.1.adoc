...
:mywidth: 32
image:sae/sae-2.1/descriptif.png["descriptif",width={mywidth}%,pdfwidth={mywidth}%]
image:sae/sae-2.1/cursus.png["cursus",width={mywidth}%,pdfwidth={mywidth}%]
image:sae/sae-2.1/competences.png["competences",width={mywidth}%,pdfwidth={mywidth}%]
...
- xref:competences/c1.adoc[Compétence 1 (Développer des applications informatiques simples)] (40%)
