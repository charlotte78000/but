...
:mywidth: 32
image:sae/sae-1.5/descriptif.png["descriptif",width={mywidth}%,pdfwidth={mywidth}%]
image:sae/sae-1.5/cursus.png["cursus",width={mywidth}%,pdfwidth={mywidth}%]
image:sae/sae-1.5/competences.png["competences",width={mywidth}%,pdfwidth={mywidth}%]
...
- xref:competences/c5.adoc[Compétence 5 (Identifier les besoins métiers des clients et des utilisateurs)] (40%)
...
====
- {ep} (p)
- {jmb} (p) image:sae/sae-1.5/jmb.jpg[width=10%, pdfwidth=10%] 
- {lc}  (v)
+
