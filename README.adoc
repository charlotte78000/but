...
Pour ajouter une page, aller au niveau du répertoire concerné. 

Pour enregistrer la page,aller dans le fichier (/nav.adoc) associé de la manière suivante:

    <xref:page.adoc>

=== Images

Pour stocker les images au niveau du répertoire concerné dans le dossier */images*.
